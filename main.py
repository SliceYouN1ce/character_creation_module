...
def attack(char_name: str, char_class: str) -> str:
    """Count how many damage character dealt."""
...
def defence(char_name: str, char_class: str) -> str:
    """Count how many damage character blocked."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} блок не подействовал')


def special(char_name: str, char_class: str) -> str:
    """Show what special ability character used."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Train your character how to fight."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Allow the player choose a class for the character."""
